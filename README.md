...
| The Hundred Line -Last Defense Academy- `US` | `0100748021808000` | `D1D3FFB94AB458B4` ([✅](SaltySD/plugins/FPSLocker/patches/0100748021808000/D1D3FFB94AB458B4.yaml), v7, 1.1.2) <br> `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/0100748021808000/D4A7205845845BCA.yaml), v9, 1.2.1) | ~~[🔐](#🔐)~~ |
| HUNDRED LINE -最終防衛学園- | `010079C01CFA6000` | `D1D3FFB94AB458B4` ([✅](SaltySD/plugins/FPSLocker/patches/010079C01CFA6000/D1D3FFB94AB458B4.yaml), v7, 1.1.2) <br> `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/010079C01CFA6000/D4A7205845845BCA.yaml), v9, 1.2.1) | ~~[🔐](#🔐)~~ |
| 百日戰記 -最終防衛學園- | `0100D9D021782000` | `D1D3FFB94AB458B4` ([✅](SaltySD/plugins/FPSLocker/patches/0100D9D021782000/D1D3FFB94AB458B4.yaml), v7, 1.1.2) <br> `D4A7205845845BCA` ([✅](SaltySD/plugins/FPSLocker/patches/0100D9D021782000/D4A7205845845BCA.yaml), v9, 1.2.1) | ~~[🔐](#🔐)~~ |
