...
<details>
<summary>List of 30 FPS locked games (1218 titles)</summary>
<h6>
...
| Animal Crossing: New Horizons | `01006F8002326000` | `8F2CB7A9774959C8` (❌, v32, 3.0.1) | [⚔️](#⚔️)[⏱️](#⏱️)[🏃](#🏃)🖥 |
...
| BEYBLADE X EVOBATTLE | `01009F002286E000` | `6ABAF2E158BD2699` (◯, v7, 1.0.7) |  |
| ベイブレードエックス エボバトル | `0100D9702286C000` | `B5C9B62CFFC73619` (◯, v8, 1.0.8) |  |
...
| Biped 2 | `01004240237F6000` | `760BBB1B0812AE99` (◯, v4, 1.8.6) |  |
...
| Core Keeper | `010070201D1BA000` | `3C87CABDEC3FF298` (◯, v21, 1.1.2.8.B) |  |
...
| Demon Slayer -Kimetsu no Yaiba- The Hinokami Chronicles 2 | `0100AD80208A8000` | `E22022FB7024085F` (❌, v10, 1.50) | [🔐](#🔐)[🔧](#🔧)[🏃](#🏃) |
| 귀멸의 칼날 히노카미 혈풍담2 | `01001080208AA000` | `E22022FB7024085F` (❌, v10, 1.50) | [🔐](#🔐)[🔧](#🔧)[🏃](#🏃) |
| 鬼滅の刃 ヒノカミ血風譚2 | `010059301B7F0000` | `E22022FB7024085F` (❌, v10, 1.50) | [🔐](#🔐)[🔧](#🔧)[🏃](#🏃) |
...
| Diablo II: Resurrected | `0100726014352000` | `2C7F979610E99119` (◯, v31, 1.0.31.0) |  |
...
| Disney Dreamlight Valley | `0100D39012C1A000` | `BB81080BEAE77EA9` (◯, v55, 1.21.0) |  |
...
| DRAGON QUEST VII Reimagined | `0100A9D01C446000` | `AB06020960EDD828` ([✅](SaltySD/plugins/FPSLocker/patches/0100A9D01C446000/AB06020960EDD828.yaml), v1, 1.1.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
| - 드래곤 퀘스트 VII Reimagined<br>- 勇者鬥惡龍 VII Reimagined | `0100505021440000` | `AB06020960EDD828` ([✅](SaltySD/plugins/FPSLocker/patches/0100505021440000/AB06020960EDD828.yaml), v1, 1.1.0) | ~~[🔐](#🔐)[📏](#📏)[🔧](#🔧)~~ |
...
| Hello Kitty Island Adventure | `010027901C89C000` | `71DA8DA4DEA537CA` (◯, v12, 2.12.5) |  |
...
| Kingdom Two Crowns | `01005EF003FF2000` | `05A597B7593CC7AD` (◯, v33, 2.3.2) |  |
...
| LEGO Party | `0100A760232D2000` | `54F62527DE065A90` (◯, v3, 1.3.6) |  |
...
| Little Kitty, Big City | `01000A4019FA2000` | `8563D95BDCD38F47` (◯, v18, 1.26.1.30_6117) |  |
...
| MIO: Memories In Orbit | `01000A001E978000` | `8006DAE28902A3D4` (◯, v1, 1.1.0.0) |  |
...
| Monster Train 2 | `010051701FB46000` | `BDBE3E552B0528A5` (◯, v9, 2.0.4) |  |
...
| NBA 2K26 | `0100CBF022E18000` | `D2B27895B7AF202D` (◯, v6, 1.06) |  |
...
| ROMANCE OF THE THREE KINGDOMS 8 REMAKE | `0100C2A01A730000` | `9F7C33E21279D3E6` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2A01A730000/9F7C33E21279D3E6.yaml), v8, 1.0.8) <br> `0DF8AB5EBE689C3C` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2A01A730000/0DF8AB5EBE689C3C.yaml), v10, 1.1.0) <br> `B2533CB8C27BAFD9` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2A01A730000/B2533CB8C27BAFD9.yaml), v11, 1.1.1) | ~~[🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️)~~ |
| ROMANCE OF THE THREE KINGDOMS 8 REMAKE with Power Up Kit | `0100C2A01A730001` | `DC65CFC2ABA3C5DF` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2A01A730000/DC65CFC2ABA3C5DF.yaml), v10, 1.1.0) <br> `0E281A7F22377574` ([✅](SaltySD/plugins/FPSLocker/patches/0100C2A01A730000/0E281A7F22377574.yaml), v11, 1.1.1) | ~~[🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️)~~ |
...
| 三國志8 REMAKE with パワーアップキット | `0100BD501A72E001` | `C9C510630375FFE6` ([✅](SaltySD/plugins/FPSLocker/patches/0100BD501A72E001/C9C510630375FFE6.yaml), v10, 1.1.0) | ~~[🔐](#🔐)[⏱️](#⏱️)[🖥️](#🖥️)~~ |
...
| Rune Factory: Guardians of Azuma `US` | `010022A02008C000` | `F678FD2BB197125B` ([✅](SaltySD/plugins/FPSLocker/patches/010022A02008C000/F678FD2BB197125B.yaml), v7, 1.1.1) <br> `02F0B93D14038350` ([✅](SaltySD/plugins/FPSLocker/patches/010022A02008C000/02F0B93D14038350.yaml), v8, 1.1.3) | ~~[📏](#📏)[🔧](#🔧)~~ |
| Rune Factory: Guardians of Azuma `Cartridge only` | `0100CFB01CDCE000` | `F678FD2BB197125B` ([✅](SaltySD/plugins/FPSLocker/patches/0100CFB01CDCE000/F678FD2BB197125B.yaml), v7, 1.1.1) <br> `02F0B93D14038350` ([✅](SaltySD/plugins/FPSLocker/patches/0100CFB01CDCE000/02F0B93D14038350.yaml), v8, 1.1.3) | ~~[📏](#📏)[🔧](#🔧)~~ |
...
| ソニックフォース 新価格版 | `0100111004460000` | `972D8BF172E86C18` (❌📌, v3, 1.3.0) | [🔐](#🔐)[⚔️](#⚔️)[🔢](#🔢) |
...
| Tales of Xillia Remastered `US` | `0100DC601BB9A000` | `252525232F08D487` (❌📌, v3, 1.0.3) | [⏱️](#⏱️) |
...
| Tomb Raider: Definitive Edition | `0100092021C80000` | `2A4A71E176DAA356` ([✅](SaltySD/plugins/FPSLocker/patches/0100092021C80000/2A4A71E176DAA356.yaml), v1, 1.0.1) <br> `AD288DAF31DEEDFD` ([✅](SaltySD/plugins/FPSLocker/patches/0100092021C80000/AD288DAF31DEEDFD.yaml), v2, 1.0.2) | ~~[📏](#📏)~~ |
